...
declare module 'chronos-date' {
	interface Chronos {
		...
		/**
		 * @instance Returns the number of full weeks between the input date and the current instance.
		 * @param time Optional time to compare with the `Chronos` date/time. Defaults to current time.
		 * @returns The difference in number, negative if past, positive if future.
		 */
		...
		/**
		 * @instance Returns the number of full hours between the input date and the current instance.
		 * @param time Optional time to compare with the `Chronos` date/time. Defaults to current time.
		 * @returns The difference in number, negative if past, positive if future.
		 */
