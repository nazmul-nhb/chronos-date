...
export class Chronos<Tz extends ChronosTimeZone = 'System'> {
	 ...
	 *
	 * @remarks
	 * - Invoking the {@link https://chronos-date.vercel.app/docs/plugins/timezone-plugin#timezone timeZone} method sets the timezone name that corresponds to the specified UTC offset, or the UTC offset itself if no name exists. For more details on this behavior, see {@link https://chronos-date.vercel.app/docs/plugins/timezone-plugin#gettimezonename getTimeZoneName}.
	 ...
	 *
	 * - **{@link $TimeZoneIdentifier}** — e.g., `"Asia/Dhaka"`. Returned when the {@link https://chronos-date.vercel.app/docs/plugins/timezone-plugin#timezone timeZone} method has not been invoked. It is default behavior.
	 ...
	 *
	 * @remarks
	 * - By default, when {@link https://chronos-date.vercel.app/docs/plugins/timezone-plugin#timezone timeZone} is not applied, a single {@link $TimeZoneIdentifier} string is provided.
	...
	/** Tracker to identify the instance created by {@link https://chronos-date.vercel.app/docs/plugins/timezone-plugin#timezone timeZone} method */
	...
	*[Symbol.iterator](): IterableIterator<[string, number]> {
	 ...
	 * - {@link https://chronos-date.vercel.app/docs/plugins/timezone-plugin#timezone timeZone}, {@link utc}, or {@link toUTC} methods have no effects on this method.
	 ...
	 * @param tzTracker Optional tracker to identify the instance created by {@link https://chronos-date.vercel.app/docs/plugins/timezone-plugin#timezone timeZone} method.
	...
	/**
	 * @instance Returns a new `Chronos` instance advanced by the specified time unit.
	 * @param unit The time unit to advance by. Default is `'day'`.
	 *
	 * @remarks Advances the date/time by exactly the specified unit while preserving other components whenever possible.
	 */
	...
	/**
	 * @instance Returns a new `Chronos` instance moved back by specified time unit.
	 * @param unit The time unit to move back by. Default is `'day'`.
	 *
	 * @remarks Moves the date/time backward by exactly the specified unit while preserving other components whenever possible.
	 */
	 ...
	 *
	 * This method strictly uses the **calendar year**. For fiscal quarters, use {@link https://chronos-date.vercel.app/docs/plugins/business-plugin#getfiscalquarter getFiscalQuarter} instead.
	 *
	 * @example
