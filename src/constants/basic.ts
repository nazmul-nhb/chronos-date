import type { $TimeUnitVar, ClockHour, DayPart, TimeUnit } from 'src/types';
...
/** Array of date parts */
export const DATE_PARTS = /* @__PURE__ */ Object.freeze([
	'night',
	'midnight',
	'lateNight',
	'morning',
...
export const DATE_PART_RANGES = /* @__PURE__ */ Object.freeze({
	...
	afternoon: ['12', '16'],
	evening: ['17', '20'],
} satisfies Record<DayPart, [ClockHour, ClockHour]>);
