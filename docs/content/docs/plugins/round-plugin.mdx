---
title: Round Plugin
description: Round Plugin — Chronos Documentation.
---
...
- `nearest` defines the multiple to round to (e.g., 15-minute intervals), internally uses [**roundToNearest** from `nhb-toolbox`](https://toolbox.nazmul-nhb.dev/docs/utilities/number/roundToNearest).
