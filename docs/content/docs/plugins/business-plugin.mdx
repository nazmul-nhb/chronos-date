...
const toAcademicYear = c.toAcademicYear();
const toFiscalQuarter = c.toFiscalQuarter();
...
| [`toAcademicYear`](#toacademicyear)   | Converts the current date to the academic year.           | `number`  |
| [`toFiscalQuarter`](#tofiscalquarter) | Converts the current date to the fiscal quarter.          | `number`  |
