...
<Callout type="info" title="About Bangla Plugin">
Bangla plugin is a plugin that adds Bangla calendar functionality to `Chronos`. Think of this plugin as a locale for Bangla calendar.
</Callout>
...
chronos.$configureBangla({ variant: 'revised-1966' });
