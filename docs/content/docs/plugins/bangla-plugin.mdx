...
description: Bangla Calendar Integration — chronos-date API reference.
---
...
- Dedicated class: [**BanglaCalendar**](/docs/classes/BanglaCalendar) for Bangla date manipulation without using [**Chronos**](/docs/api/chronos-class)
