...
description: Timezone Plugin — Chronos Documentation.
---

<Callout type="info" title="About Timezone Plugin">
Timezone plugin is a plugin that adds timezone functionality to `Chronos`.
</Callout>
