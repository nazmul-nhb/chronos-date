...
You can inject plugins via the static [`Chronos.use()`](/docs/static-methods#use) or [`Chronos.register()`](/docs/static-methods#register) method or its wrapper function:
