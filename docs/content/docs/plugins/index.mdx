---
title: Plugins
description: Chronos Plugins — chronos-date API reference.
icon: Blocks
---
...
| `banglaPlugin`   | <Copy message="Import Statement Copied!" afterCopy="Import Statement Copied!" text="import { banglaPlugin } from 'chronos-date/plugins/banglaPlugin';" />     | [Bangla calendar methods](bangla-plugin#-methods-added-by-this-plugin) |
