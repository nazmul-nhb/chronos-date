...
To enable a plugin, use the static [`Chronos.use()`](/docs/chronos/static-methods#use) or [`Chronos.register()`](/docs/chronos/static-methods#register) method **before creating instances**:
