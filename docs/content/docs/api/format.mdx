...
description: Format Methods — chronos-date API reference.
---

## Format Tokens

<Callout type="info">
`Chronos` supports a rich set of format tokens that you can use to customize how a date is displayed. These tokens work across [`format`](#format), [`formatUTC`](#formatutc), and [`formatStrict`](#formatstrict) methods as well as for other methods and utilities like [`formatDate`](/docs/utilities/formatDate) that accept a format, and behave similarly to libraries like `Moment.js` or `Day.js`.
</Callout>
...
| -------------------------------------------- | ---------------------- | ----------------- |
| `YYYY` or `yyyy` | Full year              | 2025              |
| `YY` or `yy`     | 2-digit year           | 23                |
...
| `ddd`                          | Full weekday           | Monday            |
| `dd`                           | Short weekday          | Mon               |
| `d`                            | Shorter weekday        | Mo                |
| `HH`                           | 24-hour (00-23)        | 09                |
| `H`                            | 24-hour (0-23)         | 9                 |
| `hh`                           | 12-hour (01-12)        | 02                |
| `h`                            | 12-hour (1-12)         | 2                 |
...
| `ss`                           | Seconds (00-59)        | 09                |
| `s`                            | Seconds (0-59)         | 9                 |
| `ms`                           | Milliseconds (0-999)   | 9                 |
| `mss`                          | Milliseconds (000-999) | 009               |
| `A`                            | AM/PM                  | PM                |
| `a`                            | am/pm                  | pm                |
| `ZZ`                           | TZ Offset ±HH:mm       | +06:00 or Z (UTC) |
...
> This method internally uses [getGreeting](/docs/utilities/getGreeting) function. For detailed usage please refer to the docs.
