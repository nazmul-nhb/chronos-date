...
<Tabs>
<Tab value="fixed" label="Fixed Range">
...
<Tab value="relative" label="Relative Range">
...
<Tabs>
<Tab value="fixed-options" label="Fixed Range Options">
...
<Tab value="relative-options" label="Relative Range Options">
...
<Tab value="implementation-options" label="Implementation Options">
...
<Tabs>
<Tab value="fixed-example" label="Fixed Range">
...
<Tab value="relative-example" label="Relative Range">
...
<Tab value="rounding-example" label="With Rounding">
