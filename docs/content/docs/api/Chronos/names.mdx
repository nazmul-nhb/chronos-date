...
<Tab value="bangladesh" label="Bangladesh">
...
<Tab value="philippines" label="Philippines">
...
<Tab value="australia" label="Australia">
...
<Tab value="ethiopia" label="Ethiopia">
...
<Tabs>
<Tab value="western" label="Western/Tropical">
...
<Tab value="vedic" label="Vedic/Sidereal">
