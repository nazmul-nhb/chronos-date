...
description: Name Getter Methods — chronos-date API reference.
---
...
<Callout type="warn" title="Boundary Handling">
...
<Tabs>
<Tab value="default" label={ <span style={{ whiteSpace: 'nowrap' }}>Default (Western)</span> }>
...
<Tab value="india" label={ <span style={{ whiteSpace: 'nowrap' }}>India (IMD)</span> }>
...
<Tab value="academic_us" label={ <span style={{ whiteSpace: 'nowrap' }}>US Academic</span> } >
...
<Callout type="tip" title="Custom Seasons">
...
<Callout type="tip" title="Custom Zodiac">
...
<Callout type="warn" title="Important Notes about Index">
