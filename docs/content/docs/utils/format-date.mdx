...
```typescript
import { formatRelativeDateNative } from "chronos-date/utils";
```
...
// Custom formats
const timePart4 = formatTimePart('14:50', 'HH:mm'); // 24-hour format
// "14:50"

const timePart5 = formatTimePart('14:50:30', 'h:mm A'); // 12-hour format with AM/PM
// "2:50 PM"

// With timezone offset
const timePart6 = formatTimePart('14:50+06');
// "02:50:00 pm" (converted to local time)

const timePart7 = formatTimePart('14:50:00+05:30');
// "03:20:00 pm" (adjusted from +05:30 to local time)

// Complex formats
const timePart8 = formatTimePart('18:30:45', '[Time:] hh:mm:ss A');
// "Time: 06:30:45 PM"
