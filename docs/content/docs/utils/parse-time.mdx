...
**Note**: This function is designed for parsing time into ms/sec, not absolute timestamps. For date/time parsing and manipulation, consider using [Chronos](/docs/chronos) class or other [date utilities](/docs/utils).
