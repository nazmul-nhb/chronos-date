...
<Tabs items={['Fixed Range', 'Relative Range', 'Implementation']}>

<Tab value="Fixed Range">
...
<Tabs items={['Fixed Range Options', 'Relative Range Options', 'Implementation Options']}>

<Tab value="Fixed Range Options">
...
<Tab value="Implementation Options">
...
<Tabs items={['Fixed Range', 'Relative Range', 'With Rounding']}>
