...
console.log({
  timestamp: +new Chronos(),
  isoString: `${new Chronos()}`,
})
```
...
const c = new Chronos('2025-09-01T13:26:00');
const text = 'Event scheduled for 2025-09-01T13:26:00';

console.log(text.replace(c, '2025.10.15'));
...
const c = new Chronos('2025-09-01T00:00:00');
const text = 'Meeting on 2025-09-01T00:00:00 at conference room';

console.log(text.search(c)); // Returns: 11
```
...
const c = new Chronos('2025-09-01T00:00:00.000+06:00');
const text = 'Log entries: Error2025-09-01T00:00:00Nothing Serious';

console.log(text.split(c));
...
console.log({
  text1: text1.match(c)[0], // ✅ ["2025-09-01"]
  text2: text2.match(c)[0], // ✅ ["2025/09/01"]
  text3: text3.match(c)[0], // ✅ ["20250901"]
  text4: text4.match(c)[0], // ✅ ["2025-09-01T13:26:00"]
  text5: text5.match(c)[0], // ✅ ["2025/09/01 13.26.00"]
});
```
...
console.log(Object.prototype.toString.call(new Chronos())); // [object ISO String]
```
