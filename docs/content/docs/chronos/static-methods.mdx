...
description: Static Methods — Chronos Documentation.
---
...
Returns the earliest `Chronos` instance based on the underlying universal [`timestamp`](/docs/chronos/getters#timestamp).
...
Returns the latest `Chronos` instance based on the underlying universal [`timestamp`](/docs/chronos/getters#timestamp).
