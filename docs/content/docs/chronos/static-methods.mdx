...
<Tabs items={['Relative Range Options', 'Absolute Range Options']}>

<Tab value="Relative Range Options">
...
<Tab value="Absolute Range Options">
...
<Tabs items={['Relative Range', 'Absolute Range']}>

<Tab value="Relative Range">
