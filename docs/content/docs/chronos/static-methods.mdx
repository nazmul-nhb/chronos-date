...
description: Static Methods — chronos-date API reference.
---
...
[`set`](/docs/api/get-set#set) instance method for flexibility
</Callout>
---
...
<Callout type="tip" title="Similar Instance Method">
...
Returns the earliest `Chronos` instance based on the underlying universal [`timestamp`](/docs/api/getters#timestamp).
...
Returns the latest `Chronos` instance based on the underlying universal [`timestamp`](/docs/api/getters#timestamp).
